...
namespace Basics
{
    public class Startup
    {
        ...
        {   
            ...
            services.AddRazorPages().AddRazorPagesOptions(confg => {
                //in order to give authorization policy for target page
                confg.Conventions.AuthorizePage("/Razor/Policy","Admin");
                //in order to give any authorization for the target page
                confg.Conventions.AuthorizePage("/Razor/Secure");
                //in order to give authorization on the folder layer so any page beyond
                //that will inherit that authorization
                confg.Conventions.AuthorizeFolder("/RazorSecured");
                //in order to give anonmous for the target page
